...
var popup00 := preload("res://slices/slices-popup-00.tscn").instantiate()

var popupBOSS := preload("res://slices/slices-popup-boss.tscn").instantiate()




@onready var clocklabel = $"Loop-clock"
@onready var boss: = $"Slice-boss"
...
func _ready() -> void:
	$MusicManager.play_music(load("res://Music/Sincerely.mp3"))
